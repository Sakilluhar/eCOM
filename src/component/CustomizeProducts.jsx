                ...
                <div className="flex flex-col gap-4" key={option.name}>
                    ...
                    {option.choices?.map((choice)=>{
                        ...
                        return option.name === "Color" ? (
                            <li className="w-8 h-8 rounded-full ring-1 ring-gray-300 relative" style={{backgroundColor:choice.value, cursor: disabled ? "not-allowed" : "pointer",}} key={choice.description} onClick={clickHandler}>
